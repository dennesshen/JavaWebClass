    ...
    <body style="padding: 20px">
        ...
        <form class="pure-form"
            ...
            <fieldset>
                ...
                <input name="EnterCode" type="text" placeholder="請輸入授權碼">
                <img src="/JavaWeb20210531/controller/authcode" valign="middle"><p />
                <p />
                <button type="submit" 
                ...
                <button type="button" 
                        onclick="location.href = '/JavaWeb20210531/controller/bmi_session_invalidate'"
